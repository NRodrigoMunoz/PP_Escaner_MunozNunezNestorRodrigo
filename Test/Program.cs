        ...
        static void Main(string[] args)
        {
           ...
           Escaner m = new Escaner("HP", Escaner.TipoDoc.mapa);
            try
            {
                ...
                pudo = m + m3;
                pudo = m + m4;
                //Agregamos libros repetidos y mapas repetidos 
                pudo = l + l3;
                pudo = l + l4;
                pudo = l + l5;
                pudo = m + m5;
                pudo = m + m6;
                //Agregamos un libro en escaner de mapas y un mapa en escaner de libros si solo se agregan estos y se omiten
                //los repetidos hay un solo error en el metodo sobreescrito + de caso contrario habra una excepcion en el metodo sobreescrito + y ==
                pudo = m + l1;
                pudo = l + m1;
            }
